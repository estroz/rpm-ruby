cat <<EOF > SPECS/ruby-1.9.3-p551.spec
# To build:
#
...
BuildRequires:  readline libyaml libyaml-devel readline-devel ncurses ncurses-devel gdbm glibc-devel gcc unzip openssl-devel make libffi-devel
